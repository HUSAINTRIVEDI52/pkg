...
const detectPackageManager = () => {
  ...
  // Fallback check for parent directories (helpful in monorepos or nested node_modules)
  try {
...
exports.installDevDependency = async (pkg) => {
  ...
  if (isPostInstall) {
    logInfo(`Post-install detected: skipping automatic install of ${pkg} to prevent lockfile conflicts.`);
    return;
  }
